...
public static class ApplicationFeatures
{
    ...
    public static readonly FeatureFlag DatabaseSnapshots = new()
    {
        ...
        Description = "Capture named restore points before testing a feature, compare the current database state against a snapshot, and restore the database to a known development state.",
